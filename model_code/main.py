...
def get_values():
    ...
    query = "SELECT * FROM matches where game_date < '2024-08-08' and league in (23, 39) and result != '0' order by game_date"
    matches_df = pd.read_sql(query, conn)
    query = "SELECT id, name FROM teams where country = 18"
    ...
    query = "SELECT id, home_team, away_team, league, season FROM matches where game_date >= '2024-08-08' and league in (23) and home_team not in (855) and away_team not in (855) order by game_date"
