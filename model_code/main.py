...
def get_values():
    ...
    query = "SELECT * FROM matches where game_date < '2024-09-05' and league in (17, 32) and result != '0' order by game_date"
    matches_df = pd.read_sql(query, conn)
    query = "SELECT id, name FROM teams where country = 14"
    ...
    query = "SELECT id, home_team, away_team, league, season FROM matches where game_date >= '2024-09-05' and league in (17, 32) and home_team not in (857, 858, 859) and away_team not in (857, 858, 859) order by game_date"
