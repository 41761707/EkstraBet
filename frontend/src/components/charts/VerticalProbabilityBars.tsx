        ...
        {points.map((point) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex h-36 w-full max-w-[2.5rem] items-end rounded-md bg-chart-track p-1">
                <div
                  className={`w-full rounded-md transition-[height] ${
                    point.isFavorite ? "ring-2 ring-accent/70 ring-offset-1 ring-offset-surface" : ""
                  }`}
                  style={{
                    height: `${height}%`,
              ...
              <span
                className={`text-xs ${
                  point.isFavorite ? "font-semibold text-accent-text" : "text-muted"
                }`}
              >
                {point.label}
              </span>
