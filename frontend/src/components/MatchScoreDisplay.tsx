...
> = {
  sm: {
    main: "font-semibold text-accent-text",
    note: "text-[0.7rem] font-normal leading-tight text-accent-text/75",
    wrapper: "inline-flex items-baseline gap-1",
  },
  md: {
    main: "text-lg font-semibold text-accent-text",
    note: "text-xs font-normal leading-tight text-accent-text/75",
    wrapper: "inline-flex items-baseline gap-1",
  },
  lg: {
    main: "text-2xl font-bold text-accent-text sm:text-3xl",
    note: "text-xs font-medium leading-tight text-accent-text/80 sm:text-sm",
